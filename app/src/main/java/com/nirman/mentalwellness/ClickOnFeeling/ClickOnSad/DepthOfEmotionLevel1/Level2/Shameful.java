package com.nirman.mentalwellness.ClickOnFeeling.ClickOnSad.DepthOfEmotionLevel1.Level2;
...
import com.nirman.mentalwellness.ClickOnFeeling.ClickOnSad.DepthOfEmotionLevel1.Level2.Shamefulfrag.Guilty;
import com.nirman.mentalwellness.ClickOnFeeling.ClickOnSad.DepthOfEmotionLevel1.Level2.Shamefulfrag.Regretful;
import com.nirman.mentalwellness.ClickOnFeeling.CommonForAllFeelings.LastActivity;
import com.nirman.mentalwellness.R;


public class Shameful extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shameful);
        ...
        fragmentTransaction.replace(R.id.fram,new Guilty());
        fragmentManager.popBackStack();
        fragmentTransaction.commit();
        depressed.setOnClickListener(view -> {
            replaceFragment(new Regretful());
