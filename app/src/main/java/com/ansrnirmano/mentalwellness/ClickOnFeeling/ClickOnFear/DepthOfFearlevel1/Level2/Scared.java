...
import com.ansrnirmano.mentalwellness.ClickOnFeeling.ClickOnFear.DepthOfFearlevel1.Level2.Scaredfrag.Frightended;
import com.ansrnirmano.mentalwellness.ClickOnFeeling.ClickOnFear.DepthOfFearlevel1.Level2.Scaredfrag.Helpless;
...
public class Scared extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.fram,new Helpless());
        fragmentManager.popBackStack();
        fragmentTransaction.commit();
        depressed.setOnClickListener(view -> {
            replaceFragment(new Frightended());
