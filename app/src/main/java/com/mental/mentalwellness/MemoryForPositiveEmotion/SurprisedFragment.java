package com.mental.mentalwellness.MemoryForPositiveEmotion;
...
import com.mental.adapters.MemoryAdapter;
...
public class SurprisedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_surprised, container, false);
        ...
        adapter = new MemoryAdapter(getContext(),list,3);
        rcview.setAdapter(adapter);

        database.getReference().child("Memories").child(mAuth.getUid()).child("surprised")
