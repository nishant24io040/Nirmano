...
public class CustomNotification extends FirebaseMessagingService {
...
//            style.bigPicture(Glide.with(CustomNotification.this).asBitmap().load(imageUrl).submit().get());
//
...
//    }
    ...
    public void notificationActions(Map<String,String> dataMap)
    {
        ...
        Intent intent1 = new Intent(CustomNotification.this, MainActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(CustomNotification.this, 0, intent1, PendingIntent.FLAG_UPDATE_CURRENT);
